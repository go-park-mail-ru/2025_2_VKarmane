...
func TestHandlerRegisterAddsRoutes(t *testing.T) {
	...
	h.Register(publicRouter, protectedRouter, nil, nil, nil)
...
func TestRegistratorRegisterAll(t *testing.T) {
	...
	reg.RegisterAll(publicRouter, protectedRouter, uc, l, dummyAuth, dummyBudget, dummyFin)
