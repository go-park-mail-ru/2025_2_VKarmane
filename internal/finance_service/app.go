...
import (
	...
	fin "github.com/go-park-mail-ru/2025_2_VKarmane/internal/finance_service/impl"
	"github.com/go-park-mail-ru/2025_2_VKarmane/internal/finance_service/interceptors"
	finpb "github.com/go-park-mail-ru/2025_2_VKarmane/internal/finance_service/proto"
	finrepo "github.com/go-park-mail-ru/2025_2_VKarmane/internal/finance_service/repository"
	finsvc "github.com/go-park-mail-ru/2025_2_VKarmane/internal/finance_service/service"
	finusecase "github.com/go-park-mail-ru/2025_2_VKarmane/internal/finance_service/usecase"
...
func Run() error {
	...
	go func() {
		...
		appLogger.Info("Metrics server started on :8900")
		if err := http.ListenAndServe(":8900", mux); err != nil {
