...
// Source: github.com/go-park-mail-ru/2025_2_VKarmane/internal/service/auth (interfaces: AuthService)
//
// Generated by this command:
//
//	mockgen -destination=mock_auth_service.go -package=mocks github.com/go-park-mail-ru/2025_2_VKarmane/internal/service/auth AuthService
//
...
func (m *MockAuthService) EditUserByID(ctx context.Context, req models.UpdateProfileRequest, userID int) (models.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthServiceMockRecorder) EditUserByID(ctx, req, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditUserByID", reflect.TypeOf((*MockAuthService)(nil).EditUserByID), ctx, req, userID)
}
