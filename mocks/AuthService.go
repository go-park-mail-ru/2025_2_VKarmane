...
func (_m *AuthService) EditUserByID(ctx context.Context, req models.UpdateProfileRequest, userID int) (models.User, error) {
...
func (_m *AuthService) GetUserByID(ctx context.Context, userID int) (models.User, error) {
...
func (_m *AuthService) Login(ctx context.Context, req models.LoginRequest) (models.AuthResponse, error) {
...
func (_m *AuthService) Register(ctx context.Context, req models.RegisterRequest) (models.AuthResponse, error) {
	ret := _m.Called(ctx, req)
